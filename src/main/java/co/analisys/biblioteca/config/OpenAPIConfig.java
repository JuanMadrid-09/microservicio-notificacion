...
@OpenAPIDefinition(
        info = @Info(
                ...
                description = "API REST para la gestión de notificaciones en la biblioteca. " +
                        "Permite enviar notificaciones a usuarios sobre eventos del sistema. " +
        ...
        servers = {
                ...
                @Server(
                        ...
                        url = "https://api-notificacion.biblioteca.analisys.co"
                )
        },
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info()
                        .title("Microservicio Notificación - API")
                        .description("API REST completa para la gestión de notificaciones en la biblioteca. " +
                                "Incluye endpoints para envío de notificaciones y gestión de eventos del sistema. " +
